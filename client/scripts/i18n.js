    ...
    constructor() {
        this.dictionary = {
            en: {
                ...
                dialog_chat_title: "Messages",
                dialog_chat_empty: "No messages yet",
                msg_status_sending: "Sending…",
                msg_status_sent: "Sent",
                msg_status_delivered: "Delivered",
                msg_status_failed: "Failed to send",
                msg_retry: "Retry",
                voice_record_title: "Record a voice message",
                voice_recording: "Recording…",
                voice_play: "Play voice message",
                voice_receiving: "Receiving voice message…",
                voice_status_failed: "Voice message failed to send",
                voice_unavailable: "Voice message unavailable",
                voice_permission_denied: "Microphone access denied or unsupported",
                voice_notification_title: "New voice message"
            },
            zh: {
                ...
                dialog_chat_title: "消息",
                dialog_chat_empty: "暂无消息",
                msg_status_sending: "发送中…",
                msg_status_sent: "已发送",
                msg_status_delivered: "对方已收到",
                msg_status_failed: "发送失败",
                msg_retry: "重试",
                voice_record_title: "录制语音消息",
                voice_recording: "录音中…",
                voice_play: "播放语音消息",
                voice_receiving: "正在接收语音消息…",
                voice_status_failed: "语音消息发送失败",
                voice_unavailable: "语音消息不可用",
                voice_permission_denied: "麦克风权限被拒绝或不受支持",
                voice_notification_title: "收到新的语音消息"
            },
            ja: {
                ...
                dialog_chat_title: "メッセージ",
                dialog_chat_empty: "メッセージはまだありません",
                msg_status_sending: "送信中…",
                msg_status_sent: "送信済み",
                msg_status_delivered: "相手に届きました",
                msg_status_failed: "送信に失敗しました",
                msg_retry: "再送信",
                voice_record_title: "音声メッセージを録音",
                voice_recording: "録音中…",
                voice_play: "音声メッセージを再生",
                voice_receiving: "音声メッセージを受信中…",
                voice_status_failed: "音声メッセージの送信に失敗しました",
                voice_unavailable: "音声メッセージは利用できません",
                voice_permission_denied: "マイクへのアクセスが拒否されたか、対応していません",
                voice_notification_title: "新しい音声メッセージ"
            },
            ko: {
                ...
                dialog_chat_title: "메시지",
                dialog_chat_empty: "아직 메시지가 없습니다",
                msg_status_sending: "전송 중…",
                msg_status_sent: "전송됨",
                msg_status_delivered: "상대방이 수신함",
                msg_status_failed: "전송 실패",
                msg_retry: "재전송",
                voice_record_title: "음성 메시지 녹음",
                voice_recording: "녹음 중…",
                voice_play: "음성 메시지 재생",
                voice_receiving: "음성 메시지 수신 중…",
                voice_status_failed: "음성 메시지 전송 실패",
                voice_unavailable: "음성 메시지를 사용할 수 없습니다",
                voice_permission_denied: "마이크 접근이 거부되었거나 지원되지 않습니다",
                voice_notification_title: "새 음성 메시지"
            }
        };
